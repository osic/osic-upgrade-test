...
at https://github.com/openstack/tempest/tree/master/tempest/api/object_storage ]

* SWIFT TEST SUIT - swift.test.functional at https://github.com/openstack/swift/tree/master/test/functional
